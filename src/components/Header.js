  ...
  return (
    ...
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <img
              ...
              alt="Workflow"
            />
        <span class="ml-3 text-xl text-gray-100" >MHSA</span>
      </a>
      ...
      <button  onClick={handleLogout} class="inline-flex items-center bg-gray-100 text-gray-900 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Logout
